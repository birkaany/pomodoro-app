...
const Modal = ({ isSettingsOn, setIsSettingsOn, setPomodoro }) => {
  ...
  return (
    <div className={`${isSettingsOn ? "block" : "hidden"} modal absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white w-[28rem] rounded-2xl text-pmd-blue-800 p-6`}>
